...
const SingleFeature = ({ feature }: { feature: Feature }) => {
  return (
    <div className="w-full sm:w-1/2 lg:w-1/3">
      <div className="sw-card-glow group relative overflow-hidden rounded-2xl border border-transparent px-4 py-8 text-center transition-all duration-300 hover:border-purple-500/20 hover:bg-white/10 hover:backdrop-blur-sm sm:py-10 lg:px-8 xl:px-13 xl:py-15">
        {/* Animation oder Icon */}

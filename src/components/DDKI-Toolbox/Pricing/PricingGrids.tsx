    ...
    <div>
      <div className="mx-auto max-w-[1170px] px-4 sm:px-8 xl:px-0">
        <SectionTitle variant="software"
          ...
          title="Preise"
          paragraph="Entdecken Sie den DeepChat, Ihre intelligente, funktionsreiche und datenschutzkonforme KI-Anwendung. Mit einer Vielzahl an Funktionalitäten, perfekt für den Unterricht oder als administrative Unterstützung und mit höchsten Datenschutzstandards. Ob für Schulen, Schulträger, Medienzentren, Bundesländer oder Hochschulen, profitieren Sie von einem maßgeschneiderten DeepChat, der flexibel und sicher sind."
        />
